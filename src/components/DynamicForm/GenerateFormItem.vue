<template>
  <el-form-item :label="widget.name"
    ...
    <template v-if="widget.type === 'input'">
      <el-input v-if="widget.dataType === 'number' || widget.dataType === 'integer' || widget.dataType === 'float'"
    ...
    <template v-if="widget.type === 'radio'">
      <el-radio-group v-model="dataModel"
                      :style="{width: widget.width}"
                      :disabled="widget.disabled">
        <el-radio v-for="(item, index) in widget.options"
                  :key="index"
                  :label="item.value"
    ...
    <template v-if="widget.type === 'checkbox'">
      <el-checkbox-group v-model="dataModel"
                         :style="{width: widget.width}"
                         :disabled="widget.disabled">
        <el-checkbox v-for="(item, index) in widget.options"
                     :key="index"
                     :label="item.value"
                     :style="{display: widget.inline ? 'inline-block' : 'block'}">
    ...
    <template v-if="widget.type === 'select'">
      <el-select v-model="dataModel"
        ...
        <el-option v-for="item in widget.options"
                   :key="item.value"
                   :value="item.value"
