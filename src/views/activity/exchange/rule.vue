<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="活动规则名称" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.ruleName }}</span>
        </template>
      </el-table-column>

      <el-table-column label="最低限额" align="center">
        <template slot-scope="scope">
    ...
    <rule-form ref="ruleForm" :activity-rule="formData" />
  </div>
</template>
...
export default {
  components: { Pagination, RuleForm },
