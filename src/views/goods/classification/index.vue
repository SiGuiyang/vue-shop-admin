<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.className" placeholder="分类名称" style="width: 200px;" class="filter-item"/>
    ...
    <el-table
      ...
      style="width: 100%;">
      <el-table-column label="分类名称" width="160" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.className }}</span>
        </template>
      </el-table-column>
      <el-table-column label="上级分类" width="240" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.parentClassName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Banner名称" width="240" align="center">
        <template slot-scope="scope">
          <span><img :src="scope.row.title"></span>
        </template>
      </el-table-column>
    ...
    <i-form ref="dataForm" :form-data="formData" :classification="treeList" :banner-list="banners"/>
  </div>
</template>
