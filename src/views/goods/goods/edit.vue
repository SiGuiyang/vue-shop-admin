<template>
  <div class="app-container">
    <el-form ref="dataForm" :rules="rules" :model="goodsData" label-position="left" label-width="130px">
      <el-form-item label="分类名称" prop="gcsId">
        <el-select v-model="goodsData.gcsId" placeholder="分类名称" clearable class="filter-item">
      ...
      <el-form-item label="商品状态" prop="goodsStatus">
        <el-radio-group v-model="goodsData.goodsStatus" placeholder="请选择">
      ...
      <el-form-item label="产地" prop="placeOrigin">
        <el-input v-model="goodsData.placeOrigin" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="储存方式" prop="storage">
        <el-input v-model="goodsData.storage" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品价格" prop="goodsAmount">
        <el-input v-model="goodsData.goodsAmount" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品折扣价格" prop="goodsDiscountAmount">
        <el-input v-model="goodsData.goodsDiscountAmount" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品积分" prop="integral">
        <el-input v-model="goodsData.integral" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品库存" prop="goodsInventory">
        <el-input v-model="goodsData.goodsInventory" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品简介" prop="description">
        <el-input v-model="goodsData.description" type="textarea" placeholder="请设置"/>
      </el-form-item>
      <el-form-item label="商品LOGO" prop="goodsImg">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.goodsImg"/>
        </div>
      </el-form-item>
      <el-form-item label="商品banner第一页" prop="bannerFirst">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.bannerFirst"/>
        </div>
      </el-form-item>
      <el-form-item label="商品banner第二页" prop="bannerSecond">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.bannerSecond"/>
        </div>
      </el-form-item>
      <el-form-item label="商品banner第三页" prop="bannerThird">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.bannerThird"/>
        </div>
      </el-form-item>
      <el-form-item label="商品详情图一" prop="detailsImgFirst">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.detailsImgFirst"/>
        </div>
      </el-form-item>
      <el-form-item label="商品详情图二" prop="detailsImgSecond">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.detailsImgSecond"/>
        </div>
      </el-form-item>
      <el-form-item label="商品详情图三" prop="detailsImgThird">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.detailsImgThird"/>
        </div>
      </el-form-item>
      <el-form-item label="商品详情图四" prop="detailsImgFourth">
        <div style="margin-bottom: 20px">
          <Upload v-model="goodsData.detailsImgFourth"/>
        </div>
      </el-form-item>
      <el-form-item label="商品详情图五" prop="detailsImgFifth">
        <div style="margin-bottom: 20px">
