    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      ...
      <el-collapse-item title="订单信息" name="2">
        <el-row :gutter="36" class="panel-group">
          ...
          <el-col :xs="18" :sm="18" :lg="12" class="card-panel-col">
            <span>订单金额：</span>
            <span class="icon-money"><svg-icon icon-class="money" />{{ orderData.order.orderAmount }}</span>
          </el-col>
          <el-col :xs="18" :sm="18" :lg="12" class="card-panel-col">
            <span>使用积分：</span>
      ...
      <el-collapse-item title="优惠券信息" name="3">
        <el-row :gutter="36" class="panel-group">
          ...
          <el-col :xs="18" :sm="18" :lg="12" class="card-panel-col">
            <span>优惠券订单金额：</span>
            <span class="icon-money"> <svg-icon icon-class="money" /> {{ orderData.coupon.orderAmount }}</span>
          </el-col>

          <el-col :xs="18" :sm="18" :lg="12" class="card-panel-col">
            <span>优惠券减免金额：</span>
            <span class="icon-money"> <svg-icon icon-class="money" /> {{ orderData.coupon.couponAmount }}</span>
          </el-col>
      ...
      <el-collapse-item title="商品信息" name="4">
        ...
        <el-row :gutter="48" class="panel-group">
          <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <span>总计：<span class="icon-money"><svg-icon icon-class="money" /> {{ orderData.totalAmount }}</span></span>
          </el-col>
        </el-row>
      </el-collapse-item>
    </el-collapse>
