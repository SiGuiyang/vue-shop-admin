<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('system.config.id')" prop="id" sortable="custom" align="center" width="65">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('system.config.module')">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('system.config.status')" class-name="status-col">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('system.config.createUser')">
        <template slot-scope="scope">
