<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('system.role.id')" prop="id" sortable="custom" align="center" width="65">
      ...
      <el-table-column :label="$t('system.role.status')" class-name="status-col">
        <template slot-scope="scope">
          <el-tag :type="scope.row.status | statusFilter">{{ scope.row.status }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column :label="$t('system.role.createUser')">
        <template slot-scope="scope">
